package help.lixin.starlink.workflow.bridge;
...
public class ActivitiPluginBridge implements JavaDelegate {
    private Logger logger = LoggerFactory.getLogger(ActivitiPluginBridge.class);
    ...
    public ActivitiPluginBridge(ActionMediator mediator, //
    ...
    public void execute(DelegateExecution execution) {
        ...
        // stageCtx.addVar(Constant.Pipeline.PIPELINE_NODE_TASK_ID, taskId);
        // stageCtx.addVar(Constant.Pipeline.PIPELINE_NODE_ID, nodeId);
        // stageCtx.addVar(Constant.Pipeline.PIPELINE_NODE_NAME, nodeId);
        // try {
        // // 按照升序执行
        // List<IActionExecuteInterceptor> beforeInterceptors = interceptors.stream().sorted((i, j) -> {
        // return i.getOrder() - j.getOrder();
