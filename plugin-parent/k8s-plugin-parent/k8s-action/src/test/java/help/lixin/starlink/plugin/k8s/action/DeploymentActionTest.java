...
import help.lixin.config.ExpressionConfig;
...
import help.lixin.starlink.plugin.k8s.config.K8SActionConfig;
...
public class DeploymentActionTest {
    ...
    public void initApplication() {
        ...
        applicationContext.register(ExpressionConfig.class, ActionsConfig.class, K8SConfig.class,
            K8SActionConfig.class);
    ...
    public void testExecute() throws Exception {
        ...
        // ctx.setStageParams("{
        // \"yamlTemplatePath\":\"/Users/lixin/GitRepository/starlink-ce/admin/src/main/resources/deployment-template.ftl\"
        // , \"deployName\":\"${projectName}\" ,\"podLabelName\":\"app\" ,\"podLabelValue\":\"spring-web-demo-pod\",
        // \"imagePullSecretName\":\"loginharbor\" ,
        // \"image\":\"${REPOSITORY_URL}/${projectName}/${projectName}:v${SECOND}\" ,
        // \"containerName\":\"${projectName}\", \"port\":\"9091\",\"envs\":[ { \"containerName\":\"${projectName}\" ,
        // \"name\":\"app\" , \"value\":\"test\" } ] }");
        // ctx.setStageParams("{
        // \"yamlTemplatePath\":\"/Users/lixin/GitRepository/starlink-ce/admin/src/main/resources/deployment-template.ftl\"
        // , \"deployName\":\"${projectName}\" ,\"podLabelName\":\"app\" ,\"podLabelValue\":\"spring-web-demo-pod\",
