 ...
 * @Description
 */
public class CreateK8sTLSEventHandler {
    private Logger logger = LoggerFactory.getLogger(CreateK8sTLSEventHandler.class);

    private final AbstractServiceFactory k8sServiceFactory;
    private StringEncryptor stringEncryptor;

    public CreateK8sTLSEventHandler(AbstractServiceFactory k8sServiceFactory, StringEncryptor stringEncryptor) {
    ...
    public DomainEventHandlers domainEventHandlers() {
        return DomainEventHandlersBuilder
            ...
            // 事件处理
            .onEvent(SysTLSCredentialDeleteEvent.class, this::createK8sTLSCredential)
            //
            .build();
    }

    public void createK8sTLSCredential(DomainEventEnvelope<SysTLSCredentialDeleteEvent> event) {
        SysTLSCredentialDeleteEvent credentialSpecialCreateEvent = event.getEvent();
        ...
        String nameSpace = credentialSpecialCreateEvent.getNameSpace();
