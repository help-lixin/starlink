...
public interface IEurekaClient {
     ...
     * @return
     */
    Boolean registerInstance(InstanceInfo instanceInfo);
     ...
     * @return
     */
    Boolean deleteInstance(String appName, String instanceId);
     ...
     * @return
     */
    Boolean heartbeat(String appName, String instanceId);
     ...
     * @return
     */
    Boolean outOfService(String appName, String instanceId);
     ...
     * @return
     */
    Boolean backInService(String appName, String instanceId, EurekaInstanceStatus status);
     ...
     * @return
     */
    Boolean updateMetadata(String appName, String instanceId, String key, String value);
