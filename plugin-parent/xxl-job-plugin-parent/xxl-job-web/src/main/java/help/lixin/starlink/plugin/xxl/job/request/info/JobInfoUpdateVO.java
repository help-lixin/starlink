...
/**
 * @Author: 伍岳林
 * @Date: 2023/7/6 5:51 下午
 * @Description
 */
public class JobInfoUpdateVO implements Serializable {
    ...
    private Integer executorTimeout = 60; // 任务执行超时时间，单位秒

    @ApiModelProperty(value = "失败重试次数")
    private Integer executorFailRetryCount = 3; // 失败重试次数
