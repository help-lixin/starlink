...
public class NacosServiceDetailInfo implements Serializable {
    ...
    private Map<String, NacosClusterInfo> clusterMap;
     ...
     */
    public Map<String, NacosClusterInfo> getClusterMap() {
        return clusterMap;
    }
     ...
     */
    public void setClusterMap(Map<String, NacosClusterInfo> clusterMap) {
