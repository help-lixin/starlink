...
public interface IJobService {
     ...
     * @return
     */
    boolean updateJob(CreateJobContext context);
     ...
     * @return
     */
    RequestStatus deleteJob(String optionalFolderPath, String jobName);
     ...
     * @return
     */
    RequestStatus kill(String optionalFolderPath, String jobName, int buildNumber);
     ...
     * @return
     */
    JobInfo getJobInfo(String optionalFolderPath, String jobName);
    ...
    /**
     * 取最后的成品 artifacts: [ { displayPath: "spring-web-demo-1.1.0.jar", fileName: "spring-web-demo-1.1.0.jar",
     ...
     * @return
     */
    InputStream artifact(String optionalFolderPath, String jobName, int buildNumber, String relativeArtifactPath);
     ...
     * @return
     */
    ProgressiveText lookBuildLog(String optionalFolderPath, String jobName, int buildNumber, int start);
