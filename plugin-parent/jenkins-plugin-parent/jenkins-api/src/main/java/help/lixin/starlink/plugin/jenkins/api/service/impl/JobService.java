...
public class JobService implements IJobService {
    ...
    @Override
    public boolean updateJob(CreateJobContext context) {
        JobsApi jobsApi = client.api().jobsApi();
        return jobsApi.config(context.getOptionalFolderPath(),
            //
            context.getJobName(),
            //
            context.getConfigXML());
    ...
    @Override
    public InputStream artifact(String optionalFolderPath, String jobName, int buildNumber,
