 ...
 */
public class JenkinsPipelineSetupGradleVO extends JenkinsPipelineSetupCommonVO implements Serializable {
     ...
     * 是否直接调用gradle
     *
     * Column: invoke_gradle Nullable: true
     */
     ...
     *
     * Column: make_gradlew_executable Nullable: true
     */
     ...
     * 指定工作执行路径
     *
     * Column: wrapper_location Nullable: true
     */
     ...
     * 传递给Gradle构建的系统属性
     *
     * Column: system_properties Nullable: true
     */
     ...
     * 传递给Gradle构建的项目属性
     *
     * Column: project_properties Nullable: true
     */
    private String projectProperties;

    public JenkinsPipelineSetupGradleVO() {
